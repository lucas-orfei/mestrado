...
C----------------subblock run header------------------------------------
            PDATA(LIA) = 11111111.
       WRITE(*,'(1P,6E13.5)') (PDATA(LIA+II),II=1,3),
     +                        (PDATA(LIA+II),II=15,17)
       WRITE(*,'(1P,11E11.3)') (PDATA(LIA+II),II=4,14)
            DO    IL=LIA,LIA+311,8
...
C----------------subblock event header----------------------------------
            PDATA(LIA) = 33333333.
       WRITE(*,'(1P,6E13.5)') (PDATA(LIA+II),II=1,3),PDATA(LIA+6),
     +                        (PDATA(LIA+II),II=10,11) 
            DO    IL=LIA,LIA+311,8
              WRITE(8,'(1P,8E13.5)') (PDATA(II+IL),II=0,7)
            ENDDO
...
C----------------subblock event end-------------------------------------
          ELSEIF ( CIDENT .EQ. 'EVTE' ) THEN
            PDATA(LIA) = 77777777.
       WRITE(*,'(1P,6E13.5)') (PDATA(LIA+II),II=1,6)
            DO    IL=LIA,LIA+311,8
              WRITE(8,'(1P,8E13.5)') (PDATA(II+IL),II=0,7)
            ENDDO
C----------------subblock run end---------------------------------------
          ELSEIF ( CIDENT .EQ. 'RUNE' ) THEN
            PDATA(LIA) = 99999999.
       WRITE(*,'(1P,2E13.5)') (PDATA(LIA+II),II=1,2)
            DO    IL=LIA,LIA+311,8
              WRITE(8,'(1P,8E13.5)') (PDATA(II+IL),II=0,7)
            ENDDO
            GOTO 929
...
C-----------subblock with particle data---------------------------------
          DO    IL=LIA,LIA+311,8
C         WRITE(*,'(1P,E16.8,7E13.5)') (PDATA(II+IL),II=0,7)   
C         WRITE(8,'(1P,E16.8,7E13.5)') (PDATA(II+IL),II=0,7)
          WRITE(*,'(1P,8E13.5)') (PDATA(II+IL),II=0,7)   
          WRITE(8,'(1P,8E13.5)') (PDATA(II+IL),II=0,7)
          ENDDO
        ENDIF
      ENDDO
