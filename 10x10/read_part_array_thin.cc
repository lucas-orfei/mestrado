...
int main()
{
    ...
    strcpy(str_file_in, "./OUT400171");
    strcpy(str_file_out, "./tratados_10x10det/photon/photon1E17_array");
    strcpy(str_file_out2, "./tratados_fdl/photon/OUT400171_tratado");
            ...
            while (strcmp(str1, "EVTE") != 0) {
                ...
                if (idpart < 70) {
                    ...
                    if ((idpart >= 2) && (idpart <= 6)) {
                        rpart = sqrt(x * x + y * y);
                        fprintf(outputfile2, "%d %d %.3f %.3f %.3f %.3f\n", iev, idpart, x, y, rpart, th);
