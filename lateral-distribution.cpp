...
Char_t linha[10000];
    ...
    std::string line;
    std::ifstream myfile("/home/orfei/mestrado/progs/lateral_distribution/data/photon/DAT4001514_tratado");
...
FILE *fp1 = fopen("/home/orfei/mestrado/progs/lateral_distribution/data/photon/DAT4001514_tratado","r");
...
hpx= new TH1F("hpx","Primary photon 4.64E15 eV",165,0,1000);
